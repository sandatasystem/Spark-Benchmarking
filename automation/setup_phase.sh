...
# Creating a PVC
printf "\n\n\tCREATING PVC\n\n\n"
kubectl apply -f $HOME/Spark-Benchmarking/yamls/spark-benchmark-pvc.yaml -n $namespace>/dev/null
wait_till_pvc_created spark-benchmark-claim

# Creating a temp pod
printf "\n\n\tCREATING TEMP POD\n\n"
kubectl apply -f $HOME/Spark-Benchmarking/yamls/spark-benchmark-temp-pod.yaml -n $namespace>/dev/null
